/**
 * Main program for controlling simulation of FCFS,
 * SCAN and C-SCAN disk scheduling algorithms
 * 
 * takes input.txt and output.txt as command line 
 * arguments
 * 
 * Chris Boyd
 * 216 869 356
...
int main(int argc, char *argv[]) {
	...
	//read cylinders to seek to from argv[1]
	//file must have at least NUM_REQUESTS number of 
	//lines
